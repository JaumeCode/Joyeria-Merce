...
useHead({
  ...
  meta: [
    ...
    { property: 'og:url', content: 'https://joyeriamerce.es/pendientes' },
  ...
  link: [{ rel: 'canonical', href: 'https://joyeriamerce.es/pendientes' }],
  script: [{
    ...
    children: JSON.stringify({
      ...
      url: 'https://joyeriamerce.es/pendientes',
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Inicio', item: 'https://joyeriamerce.es' },
        { '@type': 'ListItem', position: 2, name: 'Pendientes', item: 'https://joyeriamerce.es/pendientes' }
      ]},
