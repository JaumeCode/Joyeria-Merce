    ...
    <div class="contenido">
      ...
      <div class="cabecera">
        ...
        <p class="cabecera_sub">
          Descubre nuestra selección de pendientes de oro, plata y acero en Joyería Mercè, Puerto de Sagunto.
      ...
      <!-- Controles -->
      <div class="controles">
        <input v-model="busqueda" class="buscador" placeholder="Buscar pendientes..." />
      ...
      <div class="rejilla" v-if="joyasPaginadas.length">
        ...
        >
          ...
          <div class="tarjeta_cuerpo">
            <p class="tarjeta_tipo">{{ joya.material }}</p>
      ...
      <div class="vacio" v-if="!joyasFiltradas.length">
        <p>✦</p>
        <p>No se encontraron pendientes con esos filtros</p>
      </div>
...
// ── SEO ───────────────────────────────────────────────────
useHead({
  title: 'Pendientes de Oro, Plata y Acero | Joyería Mercè — Puerto de Sagunto',
  meta: [
    { name: 'description', content: 'Explora nuestra colección de pendientes de oro, plata y acero en Joyería Mercè, Puerto de Sagunto. Pendientes de aro, de botón y diseños exclusivos. Ven a vernos o consulta online.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'keywords', content: 'pendientes oro Puerto de Sagunto, pendientes plata, pendientes aro, pendientes botón, joyería Puerto de Sagunto, pendientes acero, Joyería Mercè, comprar pendientes Sagunto' },
    { property: 'og:title', content: 'Pendientes de Oro, Plata y Acero — Joyería Mercè Puerto de Sagunto' },
    { property: 'og:description', content: 'Descubre pendientes de oro, plata y acero en Joyería Mercè. Aros, botones y diseños exclusivos con envío o recogida en tienda.' },
    { property: 'og:type', content: 'website' },
    { property: 'og:url', content: 'https://joyeriamerce.es/joyas/pendientes' },
    { property: 'og:image', content: 'https://joyeriamerce.es/og/pendientes.jpg' },
    { property: 'og:image:alt', content: 'Colección de pendientes de Joyería Mercè Puerto de Sagunto' },
    { property: 'og:locale', content: 'es_ES' },
    { property: 'og:site_name', content: 'Joyería Mercè' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: 'Pendientes de Oro, Plata y Acero — Joyería Mercè' },
    { name: 'twitter:description', content: 'Pendientes de oro, plata y acero en Puerto de Sagunto. Aros, botones y diseños exclusivos.' },
    { name: 'twitter:image', content: 'https://joyeriamerce.es/og/pendientes.jpg' },
  ],
  link: [{ rel: 'canonical', href: 'https://joyeriamerce.es/joyas/pendientes' }],
  script: [{
    type: 'application/ld+json',
    children: JSON.stringify({
      '@context': 'https://schema.org',
      '@type': 'CollectionPage',
      name: 'Pendientes — Joyería Mercè',
      description: 'Colección de pendientes de oro, plata y acero en Joyería Mercè, Puerto de Sagunto.',
      url: 'https://joyeriamerce.es/joyas/pendientes',
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Inicio', item: 'https://joyeriamerce.es' },
        { '@type': 'ListItem', position: 2, name: 'Pendientes', item: 'https://joyeriamerce.es/joyas/pendientes' }
      ]},
      mainEntity: { '@type': 'ItemList', name: 'Colección de pendientes', description: 'Pendientes de oro, plata y acero con diseño exclusivo' },
...
const joyasFiltradas = computed(() => {
  let resultado = store.todas.filter(j => j.tipo === 'pendientes') // 👈 único cambio lógico
