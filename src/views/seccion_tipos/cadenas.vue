    ...
    <div class="contenido">
      ...
      <div class="cabecera">
        ...
        <p class="cabecera_sub">
          Descubre nuestra selección de cadenas de oro, plata y acero en Joyería Mercè, Puerto de Sagunto.
      ...
      <!-- Controles -->
      <div class="controles">
        <input v-model="busqueda" class="buscador" placeholder="Buscar cadenas..." />
      ...
      <div class="vacio" v-if="!joyasFiltradas.length">
        <p>✦</p>
        <p>No se encontraron cadenas con esos filtros</p>
      </div>
...
// ── SEO ───────────────────────────────────────────────────
useHead({
  title: 'Cadenas de Oro, Plata y Acero | Joyería Mercè — Puerto de Sagunto',
  meta: [
    { name: 'description', content: 'Explora nuestra colección de cadenas de oro, plata y acero en Joyería Mercè, Puerto de Sagunto. Cadenas de eslabón, forzadas, barbadas y diseños exclusivos. Ven a vernos o consulta online.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'keywords', content: 'cadenas oro Puerto de Sagunto, cadenas plata, cadenas eslabón, cadenas forzadas, cadenas barbadas, joyería Puerto de Sagunto, cadenas acero, Joyería Mercè, comprar cadenas Sagunto' },
    { property: 'og:title', content: 'Cadenas de Oro, Plata y Acero — Joyería Mercè Puerto de Sagunto' },
    ...
    { name: 'twitter:title', content: 'Cadenas de Oro, Plata y Acero — Joyería Mercè' },
...
onMounted(async () => {
  cargando.value = true
  await store.cargarJoyasPorFiltro('cadenas', null, 1, 12)
