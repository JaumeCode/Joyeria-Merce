    ...
    <div class="contenido">
      ...
      <div class="cabecera">
        ...
        <p class="cabecera_sub">
          Descubre nuestra selección de colgantes de oro, plata y acero en Joyería Mercè, Puerto de Sagunto.
      ...
      <!-- Controles -->
      <div class="controles">
        <input v-model="busqueda" class="buscador" placeholder="Buscar colgantes..." />
      ...
      <div class="vacio" v-if="!joyasFiltradas.length">
        <p>✦</p>
        <p>No se encontraron colgantes con esos filtros</p>
      </div>
...
// ── SEO ───────────────────────────────────────────────────
useHead({
  title: 'Colgantes de Oro, Plata y Acero | Joyería Mercè — Puerto de Sagunto',
  meta: [
    { name: 'description', content: 'Explora nuestra colección de colgantes de oro, plata y acero en Joyería Mercè, Puerto de Sagunto. Colgantes con cadena, dijes y diseños exclusivos. Ven a vernos o consulta online.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'keywords', content: 'colgantes oro Puerto de Sagunto, colgantes plata, dijes, colgantes con cadena, joyería Puerto de Sagunto, colgantes acero, Joyería Mercè, comprar colgantes Sagunto' },
    ...
    { name: 'twitter:title', content: 'Colgantes de Oro, Plata y Acero — Joyería Mercè' },
...
onMounted(async () => {
  cargando.value = true
  await store.cargarJoyasPorFiltro('colgantes', null, 1, 12)
