<template>
  <div class="pagina">
    ...
    <div class="contenido">
      ...
      <!-- CABECERA -->
      <div class="cabecera">
        <p class="cabecera_etiqueta">✦ Detalles que enamoran</p>
        <h1>Regalos</h1>
        <p class="cabecera_sub">
          Encuentra el regalo perfecto en Joyería Mercè, Puerto de Sagunto.
          Joyas seleccionadas para sorprender: anillos, pendientes, pulseras, cadenas y colgantes.
        </p>
      </div>

      <!-- CONTROLES -->
      <div class="controles">
        <input v-model="busqueda" class="buscador" placeholder="Buscar regalo..." />
      ...
      <div class="vacio" v-if="!joyasFiltradas.length">
        <p>✦</p>
        <p>No se encontraron regalos con esos filtros</p>
      </div>
...
useHead({
  title: 'Regalos | Joyería Mercè — Puerto de Sagunto',
  meta: [
    { name: 'description', content: 'Descubre los regalos perfectos en Joyería Mercè, Puerto de Sagunto. Joyas seleccionadas para sorprender: anillos, pendientes, pulseras, cadenas y colgantes.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'keywords', content: 'regalos joyería Puerto de Sagunto, joyas regalo, anillos regalo, pendientes regalo, pulseras regalo, cadenas regalo, colgantes regalo, Joyería Mercè' },
    { property: 'og:title', content: 'Regalos — Joyería Mercè Puerto de Sagunto' },
    { property: 'og:description', content: 'Encuentra el regalo perfecto: anillos, pendientes, pulseras, cadenas y colgantes en Joyería Mercè.' },
    { property: 'og:type', content: 'website' },
    { property: 'og:url', content: 'https://joyeriamerce.es/joyas/regalos' },
    { property: 'og:image', content: 'https://joyeriamerce.es/og/regalos.jpg' },
    { property: 'og:image:alt', content: 'Regalos de Joyería Mercè Puerto de Sagunto' },
    { property: 'og:locale', content: 'es_ES' },
    { property: 'og:site_name', content: 'Joyería Mercè' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: 'Regalos — Joyería Mercè' },
    { name: 'twitter:description', content: 'Regalos seleccionados para sorprender: anillos, pendientes, pulseras, cadenas y colgantes en Puerto de Sagunto.' },
    { name: 'twitter:image', content: 'https://joyeriamerce.es/og/regalos.jpg' },
  ],
  link: [{ rel: 'canonical', href: 'https://joyeriamerce.es/joyas/regalos' }],
  script: [{
    type: 'application/ld+json',
    children: JSON.stringify({
      '@context': 'https://schema.org',
      '@type': 'CollectionPage',
      name: 'Regalos — Joyería Mercè',
      description: 'Colección de regalos en Joyería Mercè, Puerto de Sagunto.',
      url: 'https://joyeriamerce.es/joyas/regalos',
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Inicio', item: 'https://joyeriamerce.es' },
        { '@type': 'ListItem', position: 2, name: 'Regalos', item: 'https://joyeriamerce.es/joyas/regalos' }
      ]},
      mainEntity: { '@type': 'ItemList', name: 'Colección de regalos', description: 'Anillos, pendientes, pulseras, cadenas y colgantes para regalo' },
...
const joyasFiltradas = computed(() => {
  let resultado = store.todas.filter(j => j.seccion === "regalos") 
