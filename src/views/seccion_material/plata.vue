    ...
    <div class="contenido">
      ...
      <div class="cabecera">
        ...
        <p class="cabecera_sub">
          Descubre nuestra selección de joyas de plata en Joyería Mercè, Puerto de Sagunto.
          Anillos, pendientes, pulseras, cadenas y colgantes de plata con diseño exclusivo y acabados de alta calidad.
        </p>
      </div>

      <div class="controles">
        <input v-model="busqueda" class="buscador" placeholder="Buscar joya de plata..." />
      ...
      <div class="vacio" v-if="!joyasFiltradas.length">
        <p>✦</p>
        <p>No se encontraron joyas de plata con esos filtros</p>
      </div>
...
useHead({
  title: 'Joyas de Plata | Joyería Mercè — Puerto de Sagunto',
  meta: [
    { name: 'description', content: 'Explora nuestra colección de joyas de plata en Joyería Mercè, Puerto de Sagunto. Anillos, pendientes, pulseras, cadenas y colgantes de plata. Ven a vernos o consulta online.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'keywords', content: 'joyas plata Puerto de Sagunto, anillos plata, pendientes plata, pulseras plata, cadenas plata, colgantes plata, joyería Puerto de Sagunto, Joyería Mercè, comprar plata Sagunto' },
    ...
    { name: 'twitter:title', content: 'Joyas de Plata — Joyería Mercè' },
