    ...
    <div class="contenido">
      ...
      <div class="cabecera">
        ...
        <p class="cabecera_sub">
          Descubre nuestra selección de joyas de acero en Joyería Mercè, Puerto de Sagunto.
          Anillos, pendientes, pulseras, cadenas y colgantes de acero con diseño exclusivo y acabados de alta calidad.
        </p>
      </div>

      <div class="controles">
        <input v-model="busqueda" class="buscador" placeholder="Buscar joya de acero..." />
      ...
      <div class="vacio" v-if="!joyasFiltradas.length">
        <p>✦</p>
        <p>No se encontraron joyas de acero con esos filtros</p>
      </div>
...
useHead({
  title: 'Joyas de Acero | Joyería Mercè — Puerto de Sagunto',
  meta: [
    { name: 'description', content: 'Explora nuestra colección de joyas de acero en Joyería Mercè, Puerto de Sagunto. Anillos, pendientes, pulseras, cadenas y colgantes de acero. Ven a vernos o consulta online.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'keywords', content: 'joyas acero Puerto de Sagunto, anillos acero, pendientes acero, pulseras acero, cadenas acero, colgantes acero, joyería Puerto de Sagunto, Joyería Mercè, comprar acero Sagunto' },
    { property: 'og:title', content: 'Joyas de Acero — Joyería Mercè Puerto de Sagunto' },
    { property: 'og:description', content: 'Descubre joyas de acero en Joyería Mercè. Anillos, pendientes, pulseras, cadenas y colgantes con envío o recogida en tienda.' },
    { property: 'og:type', content: 'website' },
    { property: 'og:url', content: 'https://joyeriamerce.es/joyas/acero' },
    { property: 'og:image', content: 'https://joyeriamerce.es/og/acero.jpg' },
    { property: 'og:image:alt', content: 'Colección de joyas de acero de Joyería Mercè Puerto de Sagunto' },
    { property: 'og:locale', content: 'es_ES' },
    { property: 'og:site_name', content: 'Joyería Mercè' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: 'Joyas de Acero — Joyería Mercè' },
    { name: 'twitter:description', content: 'Joyas de acero en Puerto de Sagunto. Anillos, pendientes, pulseras, cadenas y colgantes.' },
    { name: 'twitter:image', content: 'https://joyeriamerce.es/og/acero.jpg' },
  ],
  link: [{ rel: 'canonical', href: 'https://joyeriamerce.es/joyas/acero' }],
  script: [{
    type: 'application/ld+json',
    children: JSON.stringify({
      '@context': 'https://schema.org',
      '@type': 'CollectionPage',
      name: 'Joyas de Acero — Joyería Mercè',
      description: 'Colección de joyas de acero en Joyería Mercè, Puerto de Sagunto.',
      url: 'https://joyeriamerce.es/joyas/acero',
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Inicio', item: 'https://joyeriamerce.es' },
        { '@type': 'ListItem', position: 2, name: 'Acero', item: 'https://joyeriamerce.es/joyas/acero' }
      ]},
      mainEntity: { '@type': 'ItemList', name: 'Colección de joyas de acero', description: 'Anillos, pendientes, pulseras, cadenas y colgantes de acero' },
...
const joyasFiltradas = computed(() => {
  let resultado = store.todas.filter(j => j.material === 'acero')
